import { type SaveSurveyResultModel, type HttpRequest, type LoadSurveyById, type SurveyModel, type SurveyResultModel, type SaveSurveyResult } from './save-survey-result-controller-protocols'
